...
if st.button("Prediksi Hasil"):
    ...
    if prediction[0] == 1:
        st.error(f"⚠️ Pasien DIPREDIKSI MENGIDAP Penyakit Jantung (Probabilitas: {probabilitas[0][1]*100:.2f}%)")
    else:
        st.success(f"✅ Pasien DIPREDIKSI SEHAT (Probabilitas: {probabilitas[0][0]*100:.2f}%)")